...
parser.add_argument('--model', type=str, default="GPT_3_5_TURBO",
                    help="GPT Model: choose from {'GPT_3_5_TURBO', 'GPT_4', 'GPT_4_TURBO', 'GPT_4O', 'GPT_4O_MINI', 'GPT_5'},\nClaude Model: choose from {'CLAUDE_SONNET_4_5'}")
...
args2type = {'GPT_3_5_TURBO': ModelType.GPT_3_5_TURBO,
            ...
            'CLAUDE_SONNET_4_5': ModelType.CLAUDE_SONNET_4_5
             }
if openai_new_api:
